...
public class GlobalData2 {
	...
	private static GlobalData2 globalData = null;
	public static GlobalData2 getInstance() 
	{
		if (globalData == null)
		{
			globalData = new GlobalData2();
		}
		return globalData;
	}	
	...
	synchronized public void init() throws Exception
	{
		...
		id2doc = new RedisBasedMap<String, Document>(GlobalData2.K_ID2DOCUMENT, !getParams().resume_mode, new SerializeHelperAdapterDirtyBit<Document>() );
		id2wc = new RedisBasedMap<String, DocumentWordCounts>(GlobalData2.K_ID2WORD_COUNT, !getParams().resume_mode, new SerializeHelperAdapterDirtyBit<DocumentWordCounts>() );
		word2index = new RedisBasedMap<String, Integer>(GlobalData2.K_WORD2INDEX, !getParams().resume_mode, new SerializeHelperAdapterSimpleType<Integer>(Integer.class) );
		numberOfDocsIncludeWord = new RedisBasedMap<Integer, Integer>(GlobalData2.K_WORD2COUNTS, !getParams().resume_mode, new SerializeHelperIntInt() );
		resumeInfo = new RedisBasedMap<String, Integer>(GlobalData2.K_RESUME_INFO, !getParams().resume_mode, new SerializeHelperAdapterSimpleType<Integer>(Integer.class) );
		id2cluster = new RedisBasedMap<String, String>(GlobalData2.K_ID2CLUSTR_INFO, true, new SerializeHelperAdapterSimpleType<String>(String.class) );
		cluster2replacement = new RedisBasedMap<String, String>(GlobalData2.K_CLUSTR2REPLCMENT, true, new SerializeHelperAdapterSimpleType<String>(String.class) );
	...
	public void flushClusters(PrintStream outFull, PrintStream outShort, Set<String> todelete)
	{
		...
		{
			GlobalData2.id2nearestId.remove(id);
			GlobalData2.id2nearestDist.remove(id);
			GlobalData2.id2nearestOk.remove(id);
		...
		if (counter>0)
			System.out.println( "released "+counter+" clusters (" + countDocs + " docs)" );
	}
...
//	}
	...
	public void markOldClusters(Document doc) 
	{
		...
		if (old>0)
			System.out.println("marked " + old + " old clusters for cleanup");
	}
